        ...
        <table style="width: 100%;text-align: left;">
            ...
            <tr style="color: #333333;border-bottom-color: #ccc;  border-bottom-style: dashed;    border-bottom-width: 1px;    border-collapse: collapse;    border-right-color: #ccc;    border-right-style: dashed;
                ...
                <td style="border-bottom-color: #ccc;  border-bottom-style: dashed;    border-bottom-width: 1px;    border-collapse: collapse;    border-right-color: #ccc;    border-right-style: dashed;
                        border-right-width: 1px;padding: 0.5rem">
                    @if(!$service->website_name)
                        {{$service->website_name}}
                        {{$service->ssl_name}}
                        {{$service->email_name}}
                        {{$service->vps_name}}{{$service->hosting_name}}
                        {{$service->domain_name}}
                    @endif
                ...
                @if(!$service->website_name)
                    @if($extend==0)
                        <td style="border-bottom-color: #ccc;  border-bottom-style: dashed;    border-bottom-width: 1px;    border-collapse: collapse;    border-right-color: #ccc;    border-right-style: dashed;
                        border-right-width: 1px;padding: 0.5rem">
                            {{($service->hosting_price+$service->vps_price+$service->email_price+$service->ssl_price+
                                $service->domain_fee_register+$service->website_price)}}
                            đ
                        </td>
                        <td style="border-bottom-color: #ccc;  border-bottom-style: dashed;    border-bottom-width: 1px;    border-collapse: collapse;    border-right-color: #ccc;    border-right-style: dashed;
                        border-right-width: 1px;padding: 0.5rem">
                    ...
                    @if($extend==1)
                        ...
                        border-right-width: 1px;padding: 0.5rem">
                            {{($service->hosting_price+$service->vps_price+$service->email_price+$service->ssl_price+
                                $service->domain_fee_remain+$service->website_price)}}
                            đ
                        </td>
                    ...
                    @if($extend==0)
                        <td style="border-bottom-color: #ccc;  border-bottom-style: dashed;    border-bottom-width: 1px;    border-collapse: collapse;    border-right-color: #ccc;    border-right-style: dashed;
                        border-right-width: 1px;padding: 0.5rem">{{number_format(($service->hosting_price+$service->vps_price+$service->email_price+$service->ssl_price+
                            $service->domain_fee_register+$service->website_price)*($service->date_using/12))}} đ
                        </td>
                    @endif
                    @if($extend==1)
                        <td style="border-bottom-color: #ccc;  border-bottom-style: dashed;    border-bottom-width: 1px;    border-collapse: collapse;    border-right-color: #ccc;    border-right-style: dashed;
                        border-right-width: 1px;padding: 0.5rem">{{number_format(($service->hosting_price+$service->vps_price+$service->email_price+$service->ssl_price+
                            $service->domain_fee_remain+$service->website_price)*($service->date_using/12))}} đ
                        </td>
                    @endif
                @endif
            </tr>
