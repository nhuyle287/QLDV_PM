    ...
    <div class="content rollIn" style="padding-top: 1rem; margin-left: 20rem ;margin-right: 2rem ">
        <section class="header">
            ...
            <div class="title">
                ...
                <p style="margin-bottom: 0 !important;"><strong>HỢP ĐỒNG CUNG CẤP TÊN MIỀN</strong></p>
...
// overflow
            ...
            <div id="event" style="display: flex; justify-content: flex-end; margin-right: 1rem">
                ...
                <form action="{{route("admin.contract.print_domain")}}" method="POST" enctype="multipart/form-data">
                    @csrf
