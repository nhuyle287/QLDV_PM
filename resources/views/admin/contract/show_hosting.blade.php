...
{{--                        src="https://www.hoatech.vn/wp-content/uploads/2015/06/005.png"--}}
            ...
            <div class="title">
                ...
                <p style="margin-bottom: 0 !important;"><strong>     HỢP ĐỒNG CUNG CẤP DỊCH VỤ HOSTING LƯU TRỮ DỮ LIỆU TRÊN INTERNET</strong></p>
            ...
            <p style="margin-bottom: 0;text-align: justify">Hôm nay, ngày {{date('d', strtotime($con->date_create))}}
                        ...
                        <table class="service">
                            ...
                            <tr>
                                @if($hosting !== null)
                                    ...
                                    <th style="text-align: left">{{$hosting->name}} dung lượng {{$hosting->capacity}}</th>
                                    <th style="text-align: right">{{number_format($hosting->price)}}</th>


                                    <th style="text-align: right">{{$con->quantity_hosting}}</th>

                                    <th style="text-align: right">{{number_format($hosting->price*$con->quantity_hosting)}}</th>
                                @endif
                            </tr>
...
// overflow
                            ...
                            <li>2.1. Sau khi ký Hợp đồng, Bên A thanh toán ngay cho Bên B toàn bộ giá trị Hợp đồng bao
                                ...
                                <ul style="list-style-type: disc;margin-top: 0 !important; text-align: justify">
                                    <li>
                                        ...
                                        ({{convert_number_to_words($con->total_price)}})
                                    </li>
                                </ul>
            ...
            <div id="event" style="display: flex; justify-content: flex-end; margin-right: 1rem">
                ...
                <form action="{{route("admin.contract.print_hosting")}}" method="POST" enctype="multipart/form-data">
                    @csrf
