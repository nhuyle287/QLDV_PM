    ...
    <div class="content" style="padding: 1%;">
        <section class="header">
            ...
            <div class="title">
                ...
                <p>Số:01 - {{$day}}{{$month}}/HĐLTVPS/{{$year}}</p>
            </div>
            <div>
                <ul class="law">
                ...
                <div class="rules">
                    <div class="rule1">
                        ...
                        <table>
                            ...
                            <tr>
                                <th>{{$namevps}}</th>
                                <th style="text-align: right">{{number_format($price)}}</th>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right"><strong>{{number_format($vat10)}}</strong></td>
                            </tr>
                            <tr>
                                <td colspan="3"><strong>Thành tiền</strong></td>
                                <td style="text-align: right">
                                    <strong>{{number_format($total + $vat10 - $discount)}}</strong></td>
                            </tr>
                            <?php
...
// overflow
                            ...
                            <tr>
                                <td colspan="4"><strong>Bằng
                                        chữ: {{convert_number_to_words($total + $vat10 - $discount)}} đồng</strong></td>
                            ...
                            <li>2.1. Sau khi ký Hợp đồng, Bên A thanh toán ngay cho Bên B toàn bộ giá trị Hợp đồng bao
                                ...
                                <ul style="list-style-type: disc;">
                                    <li>
                                        ...
                                        {{number_format($total + $vat10 - $discount)}}đ ({{convert_number_to_words($total + $vat10 - $discount)}})
                                    </li>
                                </ul>
        ...
        <form action="{{route("admin.contract.printVPS")}}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="id_customer" value="{{$id_customer}}">
            <input type="hidden" name="quantityVPS" value="{{$quantity}}">
            <input type="hidden" name="total_price" value="{{$total}}">
            <input type="hidden" name="promotion" value="{{$promotion}}">
            <input type="hidden" name="discount" value="{{$discount}}">
            <input type="hidden" name="id_vps" value="{{$id_vps}}">
