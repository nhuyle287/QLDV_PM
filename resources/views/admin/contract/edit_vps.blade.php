            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="page-title" style="font-weight: bold; font-size: 200%;">Hợp đồng</h3>
                        <form action="{{route("admin.contract.store")}}" novalidate class="needs-validation"  method="POST" enctype="multipart/form-data"
                              id="form_dk">
                            ...
                            <table style="width: 88%;margin: 10px 10px">
                                <tr>
                                    <td colspan="6" rowspan="1"><p
                                            style="padding: 5px;display: flex; flex-wrap: nowrap">
                                            <strong style="margin-top: 8px;">Bên A:</strong>
                                            <input style="width: 90%; margin-left: 10px"

                                                   type="text" id="nameStore" class="form-control" name="nameStore"
                                                   value="{{isset($contract->nameStore) ? old('nameStore', $contract->nameStore) : old('nameStore')}}"
                                                   readonly>
                                        </p></td>
                                </tr>
                                <tr>
                                    <td colspan="1" rowspan="1"><p><span>Người đại diện:</span>
                                        </p> <input type="hidden" id="id_customer" class="form-control" readonly
                                                    name="id_customer"
                                                    value="{{isset($contract->id_customer) ? old('id_customer', $contract->id_customer) : old('id_customer')}}"
                                                    style="margin-top: 5px; margin-left: 3px"></td>
                                ...
                                <tr>
                                    <td colspan="1" rowspan="1"><p>
                                            <span>Địa chỉ:</span></p></td>
                                    <td colspan="5" rowspan="1"><p style="padding: 5px;">
                                            {{--địa chỉ--}}
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" rowspan="1"><p style="padding: 5px;">
                                            {{--số điện thoại--}}
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" rowspan="1"><p style="padding: 5px;"><span>Mở tại:</span>
                                        </p></td>
                                    <td colspan="2" rowspan="1"><p style="padding: 5px;">
                                            {{-- Mở tại--}}
                                ...
                                <tr>
                                    <td colspan="1" rowspan="1"><p style="padding: 5px;"><span>Mã số thuế:</span><span
                                            >&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span></p></td>
                                    <td colspan="2" rowspan="1"><p style="padding: 5px;">
                                            {{--số thuế--}}
                                    ...
                                    <td colspan="1" rowspan="1"><p><span>Email:</span></p></td>
                                    <td colspan="2" rowspan="1">
                                        <p style="padding: 5px;">
                                            {{-- địa chỉ email--}}
