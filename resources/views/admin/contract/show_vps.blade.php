    ...
    <div class="content rollIn" style="padding-top: 1rem; margin-left: 20rem ;margin-right: 2rem ">
        <section class="header">
            <div class="head">
                ...
                <div class="infor">
                    <ul id="infor">
                        ...
                        <li> Điện thoại: <strong>08.6846 6975 - 0988 196 169 - Website: www.hoatech.vn - Email :
            ...
            <div class="title">
                ...
                <p>***********</p>
                <p><strong>HỢP ĐỒNG CUNG CẤP DỊCH VỤ VPS LƯU TRỮ DỮ LIỆU TRÊN INTERNET</strong></p>
                <p>Số:{{$con->code}}</p>
            </div>
            <div>
                <ul class="law">
            ...
            <p>Hôm nay, ngày {{date('d', strtotime($con->date_create))}}
                tháng {{date('m', strtotime($con->date_create))}} năm {{date('Y', strtotime($con->date_create))}} , tại
                công ty TNHH THƯƠNG MẠI DỊCH VỤ HOA
                TECHNOLOGY
                chúng tôi gồm có:</p>
            ...
            <div class="infor_contract">
                    ...
                    <table>
                        <tr>
                            <td colspan="6" rowspan="1">
                                <strong>Bên A: </strong>
                                <span><strong>{{$cus->nameStore}}</strong></span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="1">
                ...
                <div class="rules">
                    <div class="rule1">
                        <strong>ĐIỀU 1: NỘI DUNG CUNG CẤP DỊCH VỤ</strong>
                        ...
                        <table>
                            ...
                            <tr>
                                <th style="text-align: left">
                                    Dịch vụ VPS có dung lượng {{$vpss->capacity}}
                                </th>
                                <th style="text-align: right">{{$vpss->price}}</th>
                                <th style="text-align: right">{{$con->quantity_vps}}</th>
                                <th style="text-align: right">{{number_format($vpss->price*$con->quantity_vps)}}</th>
                            </tr>

                            <tr>
                                <td colspan="3"><strong>Tổng tiền</strong></td>
                                <td style="text-align: right">
                                    <strong>  {{number_format($vpss->price*$con->quantity_vps)}}</strong></td>
                            </tr>
                            <tr>
                                <td colspan="3"><strong>Khuyến mãi</strong></td>
                                <td style="text-align: right"><strong>  {{$con->promotion}}</strong></td>
                            </tr>
                            <tr>
                                <td colspan="3"><strong>VAT 10%</strong></td>
                                <td style="text-align: right">
                                    <strong>{{number_format($con->total_price+$con->discount_price-($vpss->price*$con->quantity_vps))}}</strong>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3"><strong>Thành tiền</strong></td>
                                <td style="text-align: right">
                                    <strong>{{number_format($con->total_price)}}</strong></td>
                            </tr>
                            <?php
...
// overflow
                            ...
                            ?>
                            <tr>
                                <td colspan="4"><strong>Bằng
                                        chữ: {{convert_number_to_words($con->total_price)}} đồng</strong></td>
                    ...
                    <div class="rule2">
                        <strong>ĐIỀU 2: PHƯƠNG THỨC THANH TOÁN</strong>
                        <ol style="list-style-type: none;">
                            <li>2.1. Sau khi ký Hợp đồng, Bên A thanh toán ngay cho Bên B toàn bộ giá trị Hợp đồng bao
                                ...
                                <ul style="list-style-type: disc;">
                                    <li>
                                        Phí dịch vụ VPS lưu trữ dữ liệu trên internet với số tiền thanh toán là:
                    ...
                    <div class="rule5">
                        <strong> ĐIỀU 5: TẠM NGỪNG DỊCH VỤ VÀ ĐƠN PHƯƠNG CHẤM DỨT HỢP ĐỒNG</strong>
                        <ol style="list-style-type: none;">
                    ...
                    <div class="rule7">
                        <strong> ĐIỀU 7: THỜI HẠN HỢP ĐỒNG</strong>
                        <p>
            ...
            <div id="event" style="display: flex; justify-content: flex-end; margin-right: 1rem">
                ...
                <form action="{{route("admin.contract.print_vps")}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{$con->id}}">
                    <input type="hidden" name="id_customer" value="{{$cus->id}}">
                    <input type="hidden" name="quantityVPS" value="{{$con->quantity_vps}}">
                    <input type="hidden" name="total_price" value="{{$con->total_price}}">
                    <input type="hidden" name="promotion" value="{{$con->promotion}}">
                    <input type="hidden" name="discount" value="{{$con->discount_price}}">
                    <input type="hidden" name="id_vps" value="{{$con->id_vps}}">
