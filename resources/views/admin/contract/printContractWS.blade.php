            ...
            <div class="head" style=" display:inline-block; margin-top: 30px !important;margin-bottom: 0 !important; padding-bottom: 0 !important;">
                ...
                <span class="infor" style="display: inline-block;padding-bottom: 0 !important;">
                    ...
                    <p> Đc: 102B, Tăng Nhơn Phú, Phường Tăng Nhơn Phú B, Quận 9, Tp
                        HCM </p>
                    <p style="margin-bottom: 0 !important;"><u style="margin-bottom: 0 !important;padding-bottom: 0 !important;"> Điện thoại: <strong style="margin-bottom: 0 !important; padding-bottom: 0 !important;"> 0868856175 - Website:
                ...
                <div>
                    <ul class="law" style="text-align: justify">
                        <li>Căn cứ Luật Thương mại nước CHXHCN Việt Nam, luật Thương mại sửa đổi thông qua ngày
                            14/06/2006
                        </li>
                        <li>Căn cứ vào quy định về quản lý, cung cấp và sử dụng tài nguyên Internet hiện hành của Bộ
                            Thông
                            tin và Truyền thông.
                        </li>
                ...
                <p style="margin-bottom: 0;text-align: justify">Hôm nay, ngày {{$day}} tháng {{$month}} năm {{$year}}, tại công
                    ty
                ...
                <div class="infor_contract">
                    ...
                    <div class="rules">
                        <div class="rule1">
                            <strong style="margin-bottom: 0 !important;">ĐIỀU 1: NỘI DUNG CÔNG VIỆC</strong>
                            <ol style="list-style-type: none;margin-top: 0 !important; text-align: justify">
                                <li>1.1 Bên B có trách nhiệm thiết kế cho bên A 01 website với nội dung theo phụ lục
                                    đính kèm.
                                </li>
                                <li>1.2 Bên B giao quyền quản trị trang web cho khách hàng theo sự chỉ định của bên A
                                    sau khi nghiệm thu.
                                </li>
                                <li>1.3 Bên B chịu trách nhiệm cung cấp không gian lưu trữ Website cho trang web trong
                                    thời
                                    gian hợp đồng có hiệu lực.
                                </li>
                                <li>1.4 Website được bên B bảo hành trong thời gian 01 năm kể từ ngày ký nghiệm thu.
                                </li>
                                    ...
                                    <table class="service">
                                        ...
                                        <tr>
                                            @if($web !== null)
                                                ...
                                                <th style="text-align: right">{{number_format($totalWS)}}</th>
                                            @endif
                                        </tr>
                                        <tr>
                                            @if($hosting !== null)

                                                    <th style="text-align: left">{{$hosting->name}}</th>
...
// overflow
                                ...
                                <li>2.2. Giá trị hợp đồng được thanh toán làm hai đợt
                                    <ul class="value_contract">
                                        <li>Đợt 01: Thanh toán phí thiết kế website, tên miền, hosting và SSL sau khi ký
                                            kết hợp
                                            đồng
                                            theo điều khoản 2.1.
                        ...
                        <div class="rule3">
                            <strong style="margin-bottom: 0 !important;">ĐIỀU 3: QUYỀN VÀ NGHĨA VỤ BÊN A</strong>
                            <ol style="list-style-type: none;margin-top: 0 !important; text-align: justify">
                                <li>3.1 Bên A có nghĩa vụ:
                                    ...
                                    <ul style="list-style-type: disc;">
                                        ...
                                        <li>Tuân thủ giao diện thiết kế Website và những nội dung đã được hai bên thống
                                            nhất
                                            trước khi việc thiết kế Website bắt đầu.
                                        </li>
                                        <li>Thanh toán cho Bên B đầy đủ các khoản chi phí khi Bên B hoàn tất công việc
                                            và
                                            bàn giao, nghiệm thu cho Bên A.
                                        </li>
                                        <li>Phải thanh toán đầy đủ các khoản chi phí còn lại theo hợp đồng trong trường
                                            hợp
                                ...
                                <li>3.2 Bên A có quyền:
                                    <ul style="list-style-type: disc;">
                                        ...
                                        <li>Khiếu nại về chất lượng dịch vụ, cước dịch vụ do Bên B cung cấp. Khiếu nại
                                            phải
                        ...
                        <div class="rule4">
                            ...
                            <ol style="list-style-type: none;margin-top: 0 !important; text-align: justify">
                                <li> 4.1 Bên B có nghĩa vụ:
                                    <ul style="list-style-type: disc;">
                                        <li>Bên B có trách nhiệm hoàn tất quá trình thiết kế theo đúng thời gian cam kết
                                            của
                                            hợp đồng với Bên A.
                                        </li>
                                        <li>Hai bên sẽ cùng tiến hành buổi tổng kết và nghiệm thu hợp đồng trên cơ sở
                                            như
                                            sau:
                                            <ul class="value_contract">
                                                <li>Hệ thống Website được thực hiện hoàn chỉnh và đầy đủ theo đúng các
                                                    nội
                                                    dung trong hợp đồng.
                                                </li>
                                                <li>Hướng dẫn Bên A người sử dụng và quản trị thông tin trên Website.
                                                </li>
                                            </ul>
                                        </li>
                                        <li>Tư vấn miễn phí cho bên A trong quá trình hoàn thiện website suốt thời hạn
                                            bảo
                                            hành.
                                        </li>
                                        <li>Cung cấp dịch vụ theo đúng nội dung đã thỏa thuận trong Hợp đồng.</li>
                                        <li>Bảo đảm chất lượng dịch vụ theo đúng các quy định về tiêu chuẩn chất lượng
                                            dịch
                                            vụ.
                                        </li>
                                        <li>Tuân thủ giao diện thiết kế Website và những nội dung đã được hai bên thống
                                        ...
                                        <li>Giữ bí mật nội dung thông tin do Bên A truyền đưa trên mạng trừ những trường
                                            hợp
                                            đặc biệt theo quy định của pháp luật.
                                        </li>
                                        <li>Kiểm tra, sửa chữa, khắc phục các sự cố xảy ra làm gián đoạn việc sử dụng
                                            Website trong vòng 24 giờ kể từ lúc phát sinh sự cố và Bên A không phải
                                            thanh
                                            toán khoản lệ phí sửa chữa này. Trong trường hợp hư hỏng do
                                            Bên A gây ra thì bên A phải thanh toán đầy đủ các khoản chi phí sửa chữa.
                                        </li>
                                        <li>Bên B phải hoàn trả lại 70% chi phí đã nhận từ bên A nếu bên B không thể
                                            thực
                                ...
                                <li>4.2 Bên B có quyền:
                                    <ul style="list-style-type: disc;">
                                        <li>Yêu cầu Bên A cung cấp tài liệu theo thời gian quy định để Bên B thực hiện
                                            việc
                                        ...
                                        <li>Thu thêm phí thiết kế nếu bên A yêu cầu thêm các chức năng ngoài những chức
                                            năng
                        ...
                        <div class="rule5">
                            <strong style="margin-bottom: 0 !important;">ĐIỀU 5: ĐIỀU KHOẢN CHUNG</strong>
                            <ol style="list-style-type: none;margin-top: 0 !important; text-align: justify">
                                <li>5.1 Mọi sửa đổi, bổ sung hợp đồng phải được ghi nhận bằng văn bản và cả hai bên nhất
                                    trí
                                    thông qua.
                                </li>
                                <li>5.2 Hai bên tạo điều kiện cho nhau hoàn thành đúng tiến độ hợp đồng.</li>
                                <li>5.3 Mọi tranh chấp trong quá trình thực hiện hợp đồng sẽ được hai bên cùng cố gắng
                                    bàn
                                    bạc giải quyết bằng thương lượng. Nếu những vấn đề phát sinh không thể thỏa thuận
                                    được
                                    giữa hai bên thì sẽ đưa ra giải quyết tại Tòa
                                    án Kinh tế TP Hồ Chí Minh. Phán quyết của Tòa án là phán quyết cuối cùng đối với cả
                                    hai
        ...
        <section class="schedule">
            <div class="schedule_head">
                <p style="margin-bottom: 0 !important;"><strong>PHỤ LỤC</strong></p>
                <p style="margin-bottom: 0 !important;">
                    <strong>ĐỀ ÁN THIẾT KẾ MỚI WEBSITE</strong>
                </p>
                <p style="margin-bottom: 0 !important;"><strong><u>PHẦN I – YÊU CẦU CHUNG</u></strong></p>
            </div>
            <div class="schedule_required">
                <ol style="list-style-type: none">
                    ...
                    <li><strong>III. YÊU CẦU VỀ CHỨC NĂNG</strong>
                        <table class="function">
                            ...
                            <tr>
                                ...
                                <td colspan="2" rowspan="1">
                                    <p style="margin-bottom: 0 !important;">Bao gồm các thông tin: </p>
                                    <ul class="value_contract">
                                        <li>Số điện thoại.</li>
                            ...
                            <tr>
                                ...
                                <td colspan="2" rowspan="1">
                                    ...
                                    <p style="margin-bottom: 0 !important;">Bao gồm các chức năng: </p>
                                    <ul class="value_contract">
                        ...
                        <br>
                        <p style="margin-bottom: 0 !important;"><strong>Ghi chú:</strong></p>
                    ...
                    <li><strong>IV. THỜI GIAN THỰC HIỆN</strong>
                        <p style="text-align: justify">Thời gian hoàn thành thiết kế website (không bao gồm nhập liệu sản phẩm):<span
                            >
                    ...
                    <li><strong>V. CHÍNH SÁCH BẢO HÀNH – BẢO TRÌ</strong>
                        <ol style="list-style-type: none;">
                            ...
                            <li><strong>3. Các hình thức hỗ trợ bảo hành, bảo trì sản phẩm</strong>
                                ...
                                <p style="margin-bottom: 0 !important;">
                                    <strong>Lưu ý:</strong>
                                <ul class="support" style="text-align: justify">
                                    ...
                                    <li style="text-align: justify">Phạm vi bảo hành không bao gồm các trường hợp lỗi do các nguyên nhân sau:
                                        <ul class="law" style="text-align: justify">
                    ...
                    <li><strong>VI. DUY TRÌ WEBSITE (Nếu có)</strong>
                        <ul class="law">
                            <li>
                                    {{$hosting->name}} {{$hosting->capacity}} : {{number_format($hosting->price * $con->quantity_hosting)}}
                                    VNĐ
