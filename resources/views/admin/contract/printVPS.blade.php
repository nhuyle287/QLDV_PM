    ...
    <div class="content">
        <section class="header">
            ...
            <div class="title">
                ...
                <p style="margin-bottom: 0 !important;"><strong>HỢP ĐỒNG CUNG CẤP DỊCH VỤ VPS LƯU TRỮ DỮ LIỆU TRÊN
                        INTERNET</strong></p>
                ...
                <div class="rules">
                    <div class="rule1">
                        ...
                        <table class="service" cellspacing="0" cellpadding="3">
                            ...
                            <tr>
                                @if($vps !== null)
                                    <th style="text-align: left">{{$vps->name}}</th>
                                    <th style="text-align: right">{{number_format($vps->price)}}</th>
...
// overflow
                    ...
                    <div class="rule3">
                        <strong  style="margin-bottom: 0 !important;"> ĐIỀU 3: TRÁCH NHIỆM CỦA BÊN A</strong>
                        <ol style="list-style-type: none;margin-top: 0 !important; text-align: justify">
