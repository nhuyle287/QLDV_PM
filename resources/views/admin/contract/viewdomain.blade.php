    ...
    <div class="content" style="padding: 1%">
        <section class="header">
            ...
            <div class="title">
                ...
                <p>***********</p>
                <p><strong>HỢP ĐỒNG CUNG CẤP TÊN MIỀN</strong></p>
                <p>Số:01-{{$day}}{{$month}}/HĐCCTM/{{$year}}</p>
            </div>
            <div>
                <ul class="law">
                ...
                <div class="rules">
                    <div class="rule1">
                        ...
                        <ol style="list-style-type: none;">
                            <li>1.1. Dịch vụ cung cấp tên miền.</li>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <th style="text-align: right">{{number_format($quantity_domain)}}</th>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right"><strong>{{number_format($total - $discount)}}</strong></td>
                            </tr>
                            <?php
...
// overflow
                            ...
                            ?>
                            <tr>
                                <td colspan="4"><strong>Bằng chữ: {{convert_number_to_words($total - $discount)}} đồng</strong></td>
                        ...
                        <ol style="list-style-type: none;">
                            <li>2.1. Sau khi ký Hợp đồng, Bên A thanh toán ngay cho Bên B toàn bộ giá trị hợp đồng bao
                                ...
                                <ul style="list-style-type: disc;">
                                    <li>
                                        Phí dịch vụ cung cấp tên miền lưu trữ dữ liệu trên internet với số tiền thanh
                                        toán là: {{number_format($total-$discount)}}đ ({{convert_number_to_words($total - $discount)}} đồng)
                                    </li>
                                </ul>
        ...
        <form action="{{route("admin.contract.printDomain")}}" method="POST" enctype="multipart/form-data" >
            @csrf
            <input type="hidden" name="id_customer" value="{{$id_customer}}">
            <input type="hidden" name="quantity_domain" value="{{$quantity_domain}}">
