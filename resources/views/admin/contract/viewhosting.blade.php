...
{{--                      src="https://www.hoatech.vn/wp-content/uploads/2015/06/005.png"--}}
            ...
            <div class="title">
                ...
                <p>***********</p>
                <p><strong>HỢP ĐỒNG CUNG CẤP DỊCH VỤ HOSTING LƯU TRỮ DỮ LIỆU TRÊN INTERNET</strong></p>
                <p>Số:01-{{$day}}{{$month}}/HĐLTHT/{{$year}}</p>
            </div>
            <div>
                <ul class="law">
            ...
            <p>Hôm nay, ngày {{$day}} tháng {{$month}} năm {{$year}}, tại công ty TNHH THƯƠNG MẠI DỊCH VỤ HOA TECHNOLOGY
                chúng tôi gồm có:</p>
                    ...
                    <table>
                        <tr>
                            <td colspan="6" rowspan="1">
                                <strong>Bên A: </strong>
                                <span><strong>{{$nameStore}}</strong></span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="1">
                ...
                <div class="rules">
                    <div class="rule1">
                        ...
                        <ol style="list-style-type: none;">
                            <li>1.1. Dịch vụ cung cấp: dịch vụ hosting lưu trữ dữ liệu trên internet.</li>
                        ...
                        <table>
                            ...
                            <tr>
                                <th>Dịch vụ hosting lưu trữ dữ liệu dung lượng {{$capacity}}</th>
                                <th style="text-align: right">{{number_format($price_hosting)}}</th>
                                <th style="text-align: right">{{number_format($quantity_hosting)}}</th>
                                <th style="text-align: right">{{number_format($total)}}</th>
                            </tr>
                            @if($promotion !== null)
                                <tr>
                                    <td colspan="3"><strong>Mã khuyến mãi</strong></td>
                                    <th style="text-align: right">{{$promotion}}</td>
                                </tr>
                            @endif
                            ...
                            <tr>
                                ...
                                <th style="text-align: right">{{number_format($vat10)}}</th>
                            </tr>
                            <tr>
                                <td colspan="3"><strong>Thành tiền</strong></td>
                                <th style="text-align: right">{{number_format($total_all)}}</th>
                            </tr>
                            <?php
...
// overflow
                            ...
                            ?>
                            <tr>
                                <td colspan="4"><strong>Bằng chữ: {{convert_number_to_words($total_all)}} đồng</strong></td>
                        ...
                        <ol style="list-style-type: none;">
                            <li>2.1. Sau khi ký Hợp đồng, Bên A thanh toán ngay cho Bên B toàn bộ giá trị Hợp đồng bao
                                ...
                                <ul style="list-style-type: disc;">
                                    <li>
                                        Phí dịch vụ hosting lưu trữ dữ liệu trên internet với số tiền thanh toán là:
                                        {{number_format($total_all)}}đ ({{convert_number_to_words($total_all)}} đồng)
                                    </li>
                                </ul>
        ...
        <form action="{{route("admin.contract.printHosting")}}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="id_customer" value="{{$id_customer}}">
            <input type="hidden" name="quantity_hosting" value="{{$quantity_hosting}}">
